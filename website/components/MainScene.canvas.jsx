...
const _MainScene = forwardRef(function MainScene(
  { showLightbox },
  forwardedRef,
) {
  // refs
  ...
  const resizeCallback = useCallback(() => {
    if (background.current) {
      ...
      */
      const z0 = -5
      const meshHeightProportion_Z0 = 0.5 // i.e mesh takes up 50% of screen vertical space
      ...
      */
      ...
      floor.current.position.setY(y - meshHeight / 2)
    }
  }, [camera, navHeight, size, topBottomPadding, viewport])
...
export const MainScene = memo(_MainScene)
